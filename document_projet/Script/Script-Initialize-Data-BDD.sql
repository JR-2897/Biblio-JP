...
insert into livre(titre,code,description,isbn)  values ("Le seigneur des anneaux : la communaute de l'anneau", "LSDA934JT","Pour avoir plus d'info, aller sur internet.","8948667847521");
