...
public class UtilisateurResourceIT {
    ...
    private static final Boolean DEFAULT_PEUT_EMPRUNTER = false;
    private static final Boolean UPDATED_PEUT_EMPRUNTER = true;
    ...
    public static Utilisateur createEntity(EntityManager em) {
        Utilisateur utilisateur = new Utilisateur()
            ...
            .peutEmprunter(DEFAULT_PEUT_EMPRUNTER);
        return utilisateur;
    }
    /**
    ...
    public static Utilisateur createUpdatedEntity(EntityManager em) {
        Utilisateur utilisateur = new Utilisateur()
            ...
            .peutEmprunter(UPDATED_PEUT_EMPRUNTER);
        return utilisateur;
    }
    ...
    public void createUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.isPeutEmprunter()).isEqualTo(DEFAULT_PEUT_EMPRUNTER);
    }
    ...
    public void getAllUtilisateurs() throws Exception {
        ...
        restUtilisateurMockMvc.perform(get("/api/utilisateurs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].peutEmprunter").value(hasItem(DEFAULT_PEUT_EMPRUNTER.booleanValue())));
    }
    ...
    public void getUtilisateur() throws Exception {
        ...
        restUtilisateurMockMvc.perform(get("/api/utilisateurs/{id}", utilisateur.getId()))
            ...
            .andExpect(jsonPath("$.peutEmprunter").value(DEFAULT_PEUT_EMPRUNTER.booleanValue()));
    }
    @Test
    @Transactional
    ...
    public void updateUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.isPeutEmprunter()).isEqualTo(UPDATED_PEUT_EMPRUNTER);
    }
