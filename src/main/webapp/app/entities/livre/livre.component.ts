...
export class LivreComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.livreService
      ...
      .subscribe(
        (res: HttpResponse<ILivre[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLivres(): void {
    this.eventSubscriber = this.eventManager.subscribe('livreListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ILivre[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
